...
- GitHub Actions: PR #80 / run `28839093570` / `verify` 成功（2分4秒）
- GitHub check-run annotations: `[]`。Node.js 20 非推奨annotationなし。
...
合格。PR上のGitHub Actionsで `verify` jobが成功し、Node.js 20 非推奨annotationが出ていないことを確認したため、ISSUE-055はクローズ可能。
