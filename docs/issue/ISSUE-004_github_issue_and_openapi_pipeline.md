...
- ADR-0007でmarker検索候補のscore解釈、並び順、最大表示件数は定義済み。選択済み状態とa11y属性は実装済みだが、キーボード操作、スクリーンリーダー確認、long title視覚回帰、10件超過表示は未実装。
...
- キーボード操作のみのcandidate selection E2Eを追加する
