...
差別化に直結するP0。2026-06-30時点で、承認済みRequirementからIssue DraftとOpenAPI Draftを生成、編集、保存できるMVP実装を追加した。2026-07-01時点で、OpenAPI Draftのvalidation API、Frontend validation導線、validation結果とReview blockerの連動を追加した。
...
- GitHub Issue公開APIでOpenAPI Draftが `invalid` または `action_required` blockerありの場合に公開を止める
