...
- ADR-0007でmarker検索候補のscore解釈、並び順、最大表示件数は定義済み。選択済み状態、a11y属性、候補ボタンのキーボード選択E2E、long title/URLの狭幅overflow検証、検索総数/不完全結果/10件超過表示は実装済みだが、スクリーンリーダー確認と10件候補時の操作性確認は未実施。
