...
- ADR-0007でmarker検索候補のscore解釈、並び順、最大表示件数は定義済み。選択済み状態、a11y属性、候補ボタンのキーボード選択E2E、long title/URLの狭幅overflow検証は実装済みだが、スクリーンリーダー確認、10件超過表示は未実装。
