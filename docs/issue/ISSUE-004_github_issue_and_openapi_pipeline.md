...
- GitHub searchのindexing delay、rate limit、retry/backoff方針はADR-0008で定義済みだが、response header parsing、非同期retry job、cooldown UIは未実装。
...
- ADR-0008に基づきGitHub Search response header parsing、非同期retry job、cooldown UIを実装する
