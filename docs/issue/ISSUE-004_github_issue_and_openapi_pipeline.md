...
差別化に直結するP0。2026-06-30時点で、承認済みRequirementからIssue DraftとOpenAPI Draftを生成、編集、保存できるMVP実装を追加した。2026-07-01時点で、OpenAPI Draftのvalidation APIとFrontend validation導線も追加した。
...
- Draftの承認状態は保存できるが、validation結果とレビュー承認の連動は未実装。
...
- validation結果をReview blocker / approval gateに接続する
