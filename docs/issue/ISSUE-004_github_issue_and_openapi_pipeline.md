...
- `publish_failed` であれば復旧UIを表示するため、pending reconciliation attemptがない失敗でも操作可能に見える。
...
- Issue Draft responseへpending reconciliation attempt summaryを追加し、復旧UI表示条件を精密化する
