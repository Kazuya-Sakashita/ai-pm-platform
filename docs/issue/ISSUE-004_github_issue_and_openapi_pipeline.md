...
- marker検索候補のscore解釈、並び順、最大表示件数、選択済み状態は未設計。
...
- marker検索候補のscore解釈、並び順、最大表示件数をADR化する
